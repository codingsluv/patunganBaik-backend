...
func (h *transactionHandler) GetNotification(c *gin.Context) {
	...
	if err != nil {
		...
		response := helper.ApiResponse("Failed to get notification", http.StatusUnprocessableEntity, "error", errorMessage)
		c.JSON(http.StatusUnprocessableEntity, response)
	...
	if err != nil {
		response := helper.ApiResponse("Failed to process notification", http.StatusInternalServerError, "error", nil)
